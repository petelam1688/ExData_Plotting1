...
png("F://Dropbox/private/working/data science/exploratory data analysis/prj1b/plot4.png", width=480, height=480)

par(mfrow=c(2,2))

plot(dfPower$Time, dfPower$Global_active_power, type="l", xlab="", ylab="Global Active Power")

plot(dfPower$Time, dfPower$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(dfPower$Time, dfPower$Global_reactive_power, type="n", xlab="datetime", ylab="Global_reactive_power")
lines(dfPower$Time, dfPower$Global_reactive_power)
